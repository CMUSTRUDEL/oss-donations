...
# npm
#######
d_funding = loadData("asking_group_npm.csv")
d_control_random = loadData("random_npm_control.csv")
d_control_top_download = loadData("highest_download_count_npm_control.csv")
d_control_commercial = loadData("commercial_npm_control.csv")
...
# All of GH
############
d_funding_all_raw = loadData("asking_group_npm_gh.csv")
d_funding_gh_raw = loadData("asking_group_npm_gh.csv")
d_control_random_gh = loadData("random_gh_control.csv")
...
# Time series data
###################
d_ask = read_csv("rdd_ask_funding_date.csv")
...
d_ask_money = read_csv("rdd_ask_funding_date_monthly_earning.csv")
...
d_get = read_csv("rdd_get_funding_date.csv")
...
d_get_money = read_csv("rdd_get_funding_date_monthly_earning.csv")
