...
table(d$num_external > exp(6))
hist(d[d$num_external <= exp(6),]$log_num_external)
...
hist(d$log_reverse_dependency_count) # ok

hist(d$log_num_commit_total) # not ok
